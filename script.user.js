...
(function() {
    ...
    var getTableDataUrl='https://midas.dianping.com/shopdiy/report/datareport/cpm/getTable';
    ...
    function getBeforeBeginDate(tmpStartDate,tmpEndDate){
    ...
    function getBeforeEndDate(tmpStartDate){
    ...
    function getLaunches(){
        ...
        //获取推广计划
        GM_xmlhttpRequest({
            url:getLaunchDataListUrl+'?_='+getNowTime(),
            method :"get",
            onload:function(xhr){
                var data=$.parseJSON( xhr.responseText )
    ...
    function getTable(ld){
        ...
        GM_xmlhttpRequest({
            url:getTableDataUrl+'?brandId=0&planId=0&originalMaterialId=0&launchId='+ld.launchId+'&beginDate='+getYesterday()+'&endDate='+getYesterday()+'&tabIds=T1001%2CT1002%2CT1003%2CT1004%2CT1006%2CT1005%2CT1010%2CT1022%2CT1009%2CT1022&groupByDimension=1',
            method :"get",
            onload:function(xhr){
                var data=$.parseJSON( xhr.responseText )
                //解析ncpm数据放入map
                ...
                if(nctmp!=null){
                    ...
                    if(isNaN(ncpm.ncpmClickAvgCost)){
                      ncpm.ncpmClickAvgCost=0
                    }
                }
    ...
    function weekGetTable(ld,xh,st,et){
        ...
        GM_xmlhttpRequest({
            url:getTableDataUrl+'?brandId=0&planId=0&beginDate='+st+'&endDate='+et+'&groupByDimension=1&period=1&timeUnit=day&tabIds=T1001%2CT1002%2CT1003%2CT1004%2CT1006%2CT1005%2CT1010%2CT1022%2CT1009&launchAimCodes=1%2C5&originalMaterialIds=0&launchIds='+ld.launchId+'&yodaReady=h5&csecplatform=4&csecversion=2.3.1',
            method :"get",
            onload:function(xhr){
                var data=$.parseJSON( xhr.responseText )
                ...
                for (var i=0;i<mxData.length;i++){
                    ...
                    if(ncpmDetail.clickAvgCost == null ){
                        ncpmDetail.clickAvgCost=0.0
                    }
    ...
    button.onclick = function (){
        ...
        //开始获取数据
        $.get(getUserInfoUrl+'?_tm='+getNowTime(),function(data){
    ...
    pbutton.onclick = function (){
        ...
        $.when(
            //r-start
            //获取账号信息
            $.get(getUserInfoUrl+'?_tm='+getNowTime()),
            //获取店铺信息
            $.get(getCityPoiIndexUrl+'?_tm='+getNowTime()),
        ).done(function(r1,r2){
            //获取账号信息
            var poiInfoss=[]
